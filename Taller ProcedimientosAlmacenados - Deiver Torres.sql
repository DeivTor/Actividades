...
/* 9.	Escriba un procedimiento que permita calcular la edad de todos los usuarios que ya existen en la tabla. Para esto será necesario crear un 
	...
	# YA QUE LO HICE EN EL PUNTO 7 Y HASTA CON UN CURSOR, ENTONCES NO CREO QUE DEBA HACER LO MISMO, PERO EN SI, LO UNICO QUE TOCARIA CAMBIAR SERÍA COLOCAR LLAMAR LA 
	# FUNCION CALCULAREDAD POR LA OPERACION DE LA LINEA 206. DE IGUAL FORMA, SI REQUIERE QUE LO HAGA, ESTARE DISPUESTO A REALIZARLO.
