...
/* 9.	Escriba un procedimiento que permita calcular la edad de todos los usuarios que ya existen en la tabla. Para esto será necesario crear un 
	...
	# PROFESORA, SIN QUERER, YO ENTENDÍ QUE DEBIA HACER LO MISMO PERO EN EL PUNTO 7, PERO AL PARECER ERA MÁS SIMPLE, ENTONCES PUES NO CREO QUE DEBA HACERLO
